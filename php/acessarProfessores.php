        ...
        <form class="main_form" action="acessarProfessores.php?id=<?php echo $idProfessor; ?>" method="post">
          <div class="form_group">
            ...
            <div class="form_input">
              ...
              <input type="text" name="genero" id="genero" value="<?php echo $professor['genero']; ?>" disabled>
            </div>
            <div class="form_input">
            ...
            <div class="form_input">
              ...
              <input type="email" name="email" id="email" value="<?php echo $professor['email']; ?>" disabled>
            </div>
            <div class="form_input">
