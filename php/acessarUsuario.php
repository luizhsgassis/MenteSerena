  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      alterarBtn.addEventListener('click', function() {
          ...
          formSelect.forEach(select => select.disabled = false);
      ...
      form.addEventListener('submit', function(event) {
          ...
          if (nome.length == 0) {
            nomeError.textContent = 'Digite o nome do usuário.';
            nomeInput.focus();
            hasError = true;
          } else {
          ...
          if (formacao.length == 0) {
            formacaoError.textContent = 'Digite a formação do usuário.';
            formacaoInput.focus();
            hasError = true;
          } else {
          ...
          if (login.length == 0 ) {
            loginError.textContent = 'Digite o login do usuário.';
            loginInput.focus();
            hasError = true;
          } else {
        ...
        <form class="main_form" action="acessarUsuario.php?id=<?php echo $idUsuario; ?>" method="post">
          <div class="form_group">
            ...
            <div class="form_input">
              ...
              <input type="text" name="email" id="email" value="<?php echo $usuario['email']; ?>" disabled>
