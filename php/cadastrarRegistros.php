...
$tipo = isset($_GET['tipo']) ? $_GET['tipo'] : 'documentos';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    switch ($tipo) {
        ...
        case 'sessoes':
            ...
            // Validações
            if (empty($idPaciente) || empty($data) || empty($registroSessao)) {
                $erro_cadastro = "Por favor, preencha todos os campos obrigatórios.";
            } else {
    ...
    <div class="body_section">
        ...
        <main>
            ...
            <div class="content">
                ...
                <?php endif; ?>
                <form class="main_form" action="cadastrarRegistros.php?tipo=<?php echo $tipo; ?>" method="post" enctype="multipart/form-data">
                    <?php
                    switch ($tipo) {
                        case 'documentos':
                            ?>
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    ...
                                    <input type="text" name="id_sessao" id="id_sessao" required>
                                </div>
                                <div class="form_input">
